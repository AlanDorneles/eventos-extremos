    ...
    <>
      <div className={styles.container}>
        <div className={styles.containerSelect}>
          <p className={styles.paramLabel}>Parâmetro</p>
          <div className={`select is-primary ${styles.paramSelect}`}>
        ...
        <div className="is-flex-direction-row is-justify-content-center is-align-content-center">
          <div className={`tabs is-small ${styles.daysTabs}`}>
            <ul>
              <li
              ...
              <li
                className={activeTab === 7 ? "is-active" : ""}
